    ...
    while True:
        ...
        try:
            ...
            if choice == '1':
                ...
                # SỬA LỖI: Xử lý kết quả trả về từ process_free_key một cách an toàn
                # Nếu thành công (trả về True), hàm sẽ return True để vào tool.
                # Nếu thất bại (trả về False), vòng lặp sẽ tiếp tục để người dùng chọn lại.
